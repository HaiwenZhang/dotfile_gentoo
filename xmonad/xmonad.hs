...
myFocusedBorderColor = "#68E862"      -- color of focused border
myNormalBorderColor  = "#60A1AD"      -- color of inactive border
...
myWorkspaces = ["1-code", "2-web", "3-chat", "4-other"] ++ map show[5..9]
